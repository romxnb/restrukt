...
Шар 6 міряє дерево кричущою архітектурою за Мартіном: закрий назви файлів, прочитай назви тек, чути продукт чи фреймворк? Список того, що дерево має кричати, дає карта: сценарії і сутності. Тека за видом коду, `Managers`, `Utils`, `Core`, дістає ім'я з цільової карти шару 5, і лише після шару 5.

## Документи проєкту

Огляд знаходить джерела мови: файл контексту агента, README, `docs/`, ADR, конвенції. Судження ґрепає їх за словами кожного імені. Документне слово стоїть на тій самій драбині, що й слово з коду: вища сходинка виграє мовчки, нижча дає рядку колонку «розходиться з» і підставу. Пропозиція не м'якшає під документ. Користувач підтверджує, відхиляє або лишає як у документі. Підтверджене всупереч документу ім'я править і документ.

## Словник

Терміни прив'язані до канонічних назв: Use Case за Кокберном, Domain Event і Aggregate за Евансом, Command і Policy з EventStorming Брандоліні, Module за Парнасом, Naming as a Process за Белші, Linguistic Antipatterns за Арнаудовою, fail-safe defaults за Зальцером і Шредером, Screaming Architecture за Мартіном. Агент знає їх за ключовим словом, тому довідники короткі. Повний перелік — `skills/revision/references/vocabulary.md`.
