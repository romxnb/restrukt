...
`date '+%H:%M:%S'`. Обери маршрут за правилом `orchestration.md`, запусти **одного** `revision-walker` з наступним вільним id `wN`. Злий уламок журналу, створи запропоновані фрагменти, познач маршрут пройденим у `_map.md`.
